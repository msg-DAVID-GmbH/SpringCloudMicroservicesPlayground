 ...
 * else.
 * </p>
 * Note that this class is not annotated with @SpringBootApplication as is VehicleDataServer.java. If you have two or more classes
 * with that annotation in your project, you get into all kinds of funny business, which you don't want to.
 */
public class VehicleDataServerWithH2 {
